...
// Use an if statement to check if either name or genre is falsy
// Select the correct postgresql string before passing it into the db.query function
// NB Don't need to add extra bit to test with 404 code as this has already been done